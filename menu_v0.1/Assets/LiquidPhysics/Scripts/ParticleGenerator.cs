...
public class ParticleGenerator : MonoBehaviour {		
	...
	public int PARTICLE_LIFETIME=100000; //How much time will each particle live
    ...
    public int particleLimit = 30;
    int i = 0;

	void Start() { 	}

	void Update() {	
		if( lastSpawnTime+SPAWN_INTERVAL<Time.time && i < particleLimit){ // Is it time already for spawning a new particle?
