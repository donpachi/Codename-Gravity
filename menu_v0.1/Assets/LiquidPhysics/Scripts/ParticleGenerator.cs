...
public class ParticleGenerator : MonoBehaviour {		
	...
	public int PARTICLE_LIFETIME=4; //How much time will each particle live
	...
	void FixedUpdate() {
        float randomNo = Random.Range(0.0f, 0.2f);
		if( lastSpawnTime+randomNo+SPAWN_INTERVAL<Time.time && particleNumber < 1){ // Is it time already for spawning a new particle?
			GameObject newLiquidParticle=(GameObject)Instantiate(Resources.Load("Prefabs/DynamicParticle")); //Spawn a particle
